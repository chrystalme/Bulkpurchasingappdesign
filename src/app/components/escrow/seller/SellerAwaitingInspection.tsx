import { ArrowLeft, Shield, Clock, TrendingUp, Package, Info, CheckCircle2 } from 'lucide-react';
      ...
      <div className="p-4 max-w-2xl mx-auto space-y-4">
        ...
        {transaction.inspectionDeadline && (
          <Card className="p-4 bg-[#6EE7B7]/5 border-[#6EE7B7]/20">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Buyer Inspection in Progress</h3>
        ...
        <Card className="p-4 bg-[#6EE7B7]/5 border-[#6EE7B7]/20">
          <div className="flex gap-3 mb-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-gray-900 mb-1">Auto-Release Protection</h4>
              <p className="text-sm text-gray-600">
                Don't worry! If the buyer takes no action within the inspection window, funds will be automatically released to you.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            {transaction.trackingId && (
              <div>
                ...
                <p className="font-medium text-[#0047AB]">{transaction.trackingId}</p>
              </div>
            )}
        ...
        <Card className="p-4">
          ...
          <div className="mt-3 bg-gray-50 rounded-lg p-3">
            <p className="text-xs text-gray-600 text-center">
              Payment will be transferred to your account within 1-2 business days after release
            </p>
          </div>
        </Card>
        ...
        <Card className="p-4 bg-gray-50 border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Buyer Inspects Order</p>
                <p className="text-xs text-gray-600">Buyer reviews quantity, quality, and condition</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white border-2 border-gray-200 flex items-center justify-center text-sm font-semibold text-gray-600">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Either by buyer confirmation or auto-release</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Funds transferred to your account</p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4 border-[#FACC15]/20 bg-[#FACC15]/5">
          <div className="flex gap-3">
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-1 text-sm">If a Dispute is Opened</h4>
