import { ArrowLeft, Scale, Image as ImageIcon, Video, FileText, Clock, AlertCircle } from 'lucide-react';
...
export function DisputeMediation({ 
  ...
  const getStatusBadge = (status: string) => {
    const config = {
      open: { label: 'Open', className: 'bg-[#0047AB]/10 text-[#0047AB] border-[#0047AB]/20' },
      under_review: { label: 'Under Review', className: 'bg-[#FACC15]/10 text-[#FACC15] border-[#FACC15]/20' },
      resolved: { label: 'Resolved', className: 'bg-[#6EE7B7]/10 text-[#10B981] border-[#6EE7B7]/20' },
    };
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F5] pb-6">
      ...
      <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="font-semibold text-gray-900">Dispute {dispute.id}</h1>
      ...
      <div className="p-4 max-w-4xl mx-auto space-y-4">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">{getReasonLabel(dispute.reason)}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-[#0047AB]">{dispute.transactionId}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {dispute.status === 'under_review' && (
            <div className="mt-4 bg-[#FACC15]/5 border border-[#FACC15]/20 rounded-lg p-3 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Our team is carefully reviewing all evidence. Expected resolution within 3-5 business days.</p>
              </div>
            </div>
          )}
        </Card>
        ...
        {/* Timeline of Events */}
        <Card className="p-4">
          <h3 className="font-semibold text-gray-900 mb-4">Timeline of Events</h3>
          <div className="space-y-3">
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#10B981] mt-1.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Order Placed & Paid</p>
            ...
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#10B981] mt-1.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900">Seller Shipped Order</p>
                <p className="text-xs text-gray-500">Oct 24, 2025 at 11:00 AM</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-2 h-2 rounded-full bg-[#10B981] mt-1.5" />
        ...
        <Tabs defaultValue="buyer" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="buyer">Buyer Evidence ({buyerEvidence.length})</TabsTrigger>
            <TabsTrigger value="seller">Seller Evidence ({sellerEvidence.length})</TabsTrigger>
          </TabsList>

          <TabsContent value="buyer" className="mt-4">
            <Card className="p-4">
              <h3 className="font-semibold text-gray-900 mb-4">Buyer's Evidence</h3>
                    ...
                    <Card key={evidence.id} className="p-4 bg-gray-50">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-900 mb-2">{evidence.description}</p>
                          <Button variant="outline" size="sm">View Full Evidence</Button>
                        </div>
                      </div>
                    </Card>
                  );
          ...
          <TabsContent value="seller" className="mt-4">
            <Card className="p-4">
              <h3 className="font-semibold text-gray-900 mb-4">Seller's Evidence</h3>
              <div className="space-y-4">
        ...
        {userRole === 'admin' && (
          <Card className="p-4">
            <h3 className="font-semibold text-gray-900 mb-4">Platform Decision</h3>
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="admin-notes" className="text-sm font-medium text-gray-700 mb-2">
                  Admin Notes
                </Label>
                <textarea
                  id="admin-notes"
        ...
        {userRole !== 'admin' && (
          <Card className="p-4 bg-gray-50 border-gray-200">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-1 text-sm">What to Expect</h4>
                <p className="text-xs text-gray-600 mb-2">
                  Our mediation team reviews all evidence objectively and makes fair decisions based on platform policies.
                </p>
                <ul className="space-y-1 text-xs text-gray-600">
                  ...
                  <li>• Funds will be distributed according to the resolution</li>
                </ul>
              </div>
            </div>
          </Card>
