    ...
    <>
      ...
      <nav className="hidden lg:block fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-50">
        <div className="p-6 h-full flex flex-col justify-between">
          ...
          {/* Bottom user profile section with avatar, name, and email (Matching Figma Design) */}
          {user && (
            <div className="border-t border-gray-200 pt-4 mt-auto">
              ...
              >
                <Avatar className="h-10 w-10 border border-gray-200 flex-shrink-0">
                  ...
                  <AvatarFallback className="bg-[#0047AB]/10 text-[#0047AB] font-bold">
                    {userInitial}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate group-hover:text-[#0047AB] transition-colors">
                    {user.name || 'User'}
                  </p>
