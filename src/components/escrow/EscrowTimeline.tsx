            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`text-xs mt-2 text-center ${step.completed || step.active ? 'text-gray-900 font-medium' : 'text-gray-500'}`}
                  >
                    {step.label}
                  </p>
                  {step.timestamp && (
              ...
              <div key={step.id} className='relative flex gap-3'>
                ...
                {!isLast && (
                  <div className='absolute left-5 top-10 bottom-0 w-0.5 bg-gray-200'>
                    {step.completed && (
                      <div className='w-full bg-[#0047AB] h-full' />
                    )}
                  </div>
                )}
                ...
                <div className='flex-1 pb-4'>
                  <p
                    className={`text-sm ${step.completed || step.active ? 'text-gray-900 font-medium' : 'text-gray-500'}`}
                  >
                    {step.label}
                  </p>
                  {step.timestamp && (
