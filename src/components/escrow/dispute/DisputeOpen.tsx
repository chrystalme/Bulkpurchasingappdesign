...
export function DisputeOpen({ 
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      toast.success('Dispute submitted successfully. Our team will review within 24 hours.');
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F5] pb-6">
      ...
      <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">Report an issue with your order</p>
          </div>
      ...
      <div className="p-4 max-w-2xl mx-auto space-y-4">
        ...
        <Card className="p-4">
          ...
          <div className="mb-4">
            ...
            <Select value={reason} onValueChange={setReason}>
              ...
              <SelectContent>
                <SelectItem value="wrong_quantity">Wrong Quantity Received</SelectItem>
                <SelectItem value="damaged">Product Damaged or Defective</SelectItem>
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Be specific and accurate. This will help our team resolve the dispute fairly.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mb-3">
              Provide clear photos or videos showing the issue. Evidence is critical for dispute resolution.
            </p>
            <EvidenceUploader
        ...
        <Card className="p-4">
          <h3 className="font-semibold text-gray-900 mb-2">Contact Seller (Optional)</h3>
          <p className="text-sm text-gray-600 mb-3">
            Sometimes issues can be resolved directly with the seller before escalating to a dispute.
          </p>
          <Textarea
        ...
        <Card className="p-4 bg-gray-50 border-gray-200">
          <h4 className="font-medium text-gray-900 mb-3 text-sm">How Dispute Resolution Works</h4>
          <div className="space-y-3">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">You provide details and evidence of the issue</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#0047AB] text-white flex items-center justify-center text-xs font-semibold">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Seller has 48 hours to provide counter-evidence</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#0047AB] text-white flex items-center justify-center text-xs font-semibold">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Our moderators review all evidence objectively</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Decision made: full refund, partial refund, or release to seller</p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-4 border-[#FB7185]/20 bg-[#FB7185]/5">
          <h4 className="font-medium text-gray-900 mb-2 text-sm">⚠️ Important Notes</h4>
          <ul className="space-y-1 text-xs text-gray-600">
            <li>• Disputes must be opened within the 72-hour inspection window</li>
            <li>• All evidence is immutable and cannot be changed after submission</li>
            <li>• False or fraudulent claims will result in account suspension</li>
