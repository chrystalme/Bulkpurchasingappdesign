...
export function BuyerTransactionDashboard({
  ...
  const canInspect =
    transaction.status === 'pending_inspection' && transaction.deliveredAt;
              ...
              <div className='flex gap-3'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-gray-600 mb-2'>
                    Funds will be automatically released to the seller if no
        ...
        <Card className='p-4'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-sm text-gray-600'>
                {transaction.status === 'locked' &&
                  'Your funds are secured. Seller cannot access them until delivery is confirmed.'}
                {transaction.status === 'pending_inspection' &&
                  'Funds are locked pending your inspection. Review your order before the deadline.'}
                {transaction.status === 'released' &&
                  'Funds have been released to the seller. Transaction complete.'}
                {transaction.status === 'disputed' &&
                  'Transaction is under dispute review. Evidence is being evaluated.'}
              </p>
            </div>
          </div>
          <div className='bg-gray-50 rounded-lg p-3 space-y-2'>
            ...
            <div className='flex justify-between text-sm'>
              ...
              <span className='font-semibold text-gray-900'>
                ${transaction.escrowFee.toFixed(2)}
              </span>
            </div>
          </div>
        </Card>
          ...
          <div className='flex gap-3'>
            ...
            <div>
              ...
              <p className='text-xs text-gray-600'>
                If you have questions about the escrow process or need
