...
export function VendorProducts({ navigate, vendorId }: VendorProductsProps) {
  ...
  const actualVendorId = user?.vendor_id || vendorId;
      ...
      <div className='min-h-screen bg-[#F4F4F5] pb-6'>
          ...
          <div className='flex items-center gap-3 mb-4'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-xs text-gray-500'>
                {vendorProducts.length} products listed
              </p>
            </div>
          </div>
        </div>
        <div className='p-4'>
          <ErrorState
            ...
            description={error}
            onRetry={() => actualVendorId && dispatch(fetchVendorProducts(actualVendorId))}
            showRetry={true}
          />
        </div>
      </div>
