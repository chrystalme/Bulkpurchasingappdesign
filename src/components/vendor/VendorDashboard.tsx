            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-semibold">${(stats.totalRevenue / 1000).toFixed(1)}k</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-semibold">{stats.totalOrders}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-semibold">{stats.totalProducts}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-white font-semibold">{stats.averageRating}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent className="p-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xl font-semibold text-gray-900">${stats.monthlyRevenue.toLocaleString()}</p>
                <p className="text-xs text-[#10B981] mt-1">+12% from last month</p>
              </div>
              <div>
                ...
                <p className="text-xs text-[#FACC15] mt-1">Requires attention</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <div key={product.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-600">MOQ: {product.moq} units</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-semibold text-[#10B981]">${product.bulkPrice}</p>
                    <p className="text-xs text-gray-500 line-through">${product.retailPrice}</p>
                  </div>
                </div>
              ))}
            </div>
